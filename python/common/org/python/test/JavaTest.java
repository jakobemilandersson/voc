...
public class JavaTest extends TestCase {
    ...
    /* THIS WORKS ON PYTHON 3 BUT NOT IN THE JAVA-PYTHON IMPLEMENTATION! (only works with type Int)
    @Test
    public void testListInsertList() {
        List original = new List();
        original.append(Int.getInt(1));
        original.append(Int.getInt(2));
        original.append(Int.getInt(3));
        ...
        insertion.append(Int.getInt(1));
        insertion.append(Int.getInt(2));

        original.insert(0, insertion)

        List validation = new List();
        validation.append(insertion);
        validation.append(Int.getInt(1));
        validation.append(Int.getInt(2));
        validation.append(Int.getInt(3));
